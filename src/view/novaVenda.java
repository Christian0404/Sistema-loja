...
public class novaVenda extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         num = num + (int) Float.parseFloat(txtValor.getText());
        
        txtPreco.setText(String.valueOf(num));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Venda Finalizada! Total da compra: R$ " + num);
        txtPreco.setText("");
        txtNome.setText("");
        txtValor.setText("");
        num = 0;
